      ...
      <AreaChart data={data} margin={{ top: 2, right: 0, left: 0, bottom: 0 }}>
        <defs>
          <linearGradient id="miniSparkFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#18bb37" stopOpacity={0.25} />
            <stop offset="100%" stopColor="#18bb37" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <Area type="monotone" dataKey="value" stroke="#169a2f" strokeWidth={2} fill="url(#miniSparkFill)" />
      </AreaChart>
    </ResponsiveContainer>
  );
}
